...
public interface Solver {
    ...
    static Solver getSolver(String name) {
        switch (name) {
            ...
            case "est_spt_random": return new GreedySolver(GreedySolver.Priority.EST_SPT, 0.95);
            case "est_lrpt_random": return new GreedySolver(GreedySolver.Priority.EST_LRPT, 0.95);
            case "desc_lrpt_random": return new DescentSolver(new Nowicki(),new GreedySolver(GreedySolver.Priority.LRPT, 0.95));
            case "desc_spt_random": return new DescentSolver(new Nowicki(),new GreedySolver(GreedySolver.Priority.SPT, 0.95));
